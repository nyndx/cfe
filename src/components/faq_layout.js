...
const FaqLayout = ({ children }) => {
  ...
  return (
    <div className="relative flex h-full ">
      ...
      <div className="relative w-3/4 max-w-2xl mx-auto overflow-y-auto">
        <div className="fixed z-30 flex items-center justify-center p-2 mt-4 bg-indigo-400 rounded-full shadow-lg right-6 bottom-6 md:hidden">
          {showSidebar ? (
            <button
